...
!!! details "show me"
    ...
    | [PrecompileSignatures](https://github.com/rikhuijzer/PrecompileSignatures.jl)| generate precompile directives |
...
!!! details "show me"
    ...
    - If you add a new public function in a module, make sure to: 
        ...
        - add a test for the function in the relevant file of the test directory
    ...
    - Before you commit any change to the github repository, make sure you can run successfully
        - the `LOCAL_BUILD.jl` script in the src/extras directory 
        - the `LOCAL_BUILD.jl` script in the docs directory
        - the `runtests.jl` script in the test directory
